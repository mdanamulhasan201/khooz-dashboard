        ...
        <>
            ...
            <div className='max-w-screen-2xl mx-auto py-10'>
                <div className='w-full p-4 mx-auto rounded-md'>
                    ...
                    <div className="w-full p-2 mx-auto rounded-md mt-2 overflow-x-auto">
                        <table className="w-full mx-auto text-sm text-left ">
                            <thead className="text-sm uppercase border-b bg-gray-200 border-slate-300 text-gray-600">
                                <tr>
                            ...
                            <tbody>
                                {
                                    displayedData.map((d, i) => (
                                        <tr key={i} className='border-b hover:shadow-md'>
