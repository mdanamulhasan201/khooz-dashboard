...
import { get_active_seller } from '../../store/Reducers/sellerReducer';
...
const Sellers = () => {
    ...
    useEffect(() => {
        ...
        dispatch(get_active_seller(obj));
                                ...
                                {currentItems.map((d, i) => (
                                    <tr key={i}>
                                        ...
                                        <td className="px-1 py-2 whitespace-nowrap text-gray-700">
                                            <span className={`${d.payment === 'active' ? 'text-green-600 bg-green-200 px-1  rounded-md' : d.payment === 'inactive' ? 'text-red-500 bg-red-200 px-1  rounded-md' : 'text-gray-700'}`}>{d.payment}</span>
                                        </td>
