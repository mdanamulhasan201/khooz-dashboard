                ...
                <div className='flex w-full h-full relative'>
                    ...
                    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
                        <div className='flex justify-between items-center'>
                            {
                                sellerId && <div className='flex justify-start items-center gap-3'>
                                    <div className='relative'>
                                        ...
                                        <img className='w-[50px]  h-[50px] border-2 border-green-600 rounded-full mx-w-[45px] p-[2px]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRij6dtiHizH96qpCOe8WeXXP3yLyQJkPdGVg&usqp=CAU" alt="" />
                            ...
                            <div className='bg-[#e7defc86] h-[calc(100vh-290px)] rounded-md p-3 overflow-x-auto'>
                                ...
                                <div className='w-full flex justify-start items-center'>
                                    <div className='flex justify-start items-start gap-2 md:px-2 py-2 max-w-full lg:mx-w-[85%]'>
                                        <div>
                                            <img className='w-[38px] p-[2px] h-[38px] border-2 border-green-600 rounded-full mx-w-[38px] ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRij6dtiHizH96qpCOe8WeXXP3yLyQJkPdGVg&usqp=CAU" alt="" />
                                ...
                                <div className='w-full flex justify-end items-center'>
                                    <div className='flex justify-start items-start gap-2 md:px-2 py-2 max-w-full lg:mx-w-[85%]'>
                                        ...
                                        <div>
                                            <img className='w-[38px] h-[38px] p-[2px] border-2 border-green-600 rounded-full mx-w-[38px] ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRij6dtiHizH96qpCOe8WeXXP3yLyQJkPdGVg&usqp=CAU" alt="" />
                        ...
                        <form className='flex gap-3 '>
                            <input className='w-full flex justify-between px-2 border border-slate-300 items-center py-[5px] focus:border-gray-500 rounded-md outline-none bg-transparent' type="text" placeholder='input your Message' />
